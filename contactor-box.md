...
For high current, this box has input and output NEMA L6-30 pigtails, plug on the input side and receptacle on the output side, connected via PG16 (or as-sized-to-cables) cable glands.
