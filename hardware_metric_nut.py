...
def apply_hex_nut_tool(
    ...
    """
    actual_clearance_dia = nut.clearance_dia + tol_clearance
    actual_across_flats = nut.across_flats + tol_flats
    circumscribed_dia = actual_across_flats / 0.866025
    
    # Hex nut pocket (blind cut from the current workplane face)
    res = (
        wp.pushPoints(locations)
