...
These can be purchased as a modified enclosure from Bud (with additional lead-time and $450 minimum order).
...
[generic_adapter_plate.py](generic_adapter_plate.py) generates adapter plates that adapt the back of these boxes to attach to the T-slot framing.
